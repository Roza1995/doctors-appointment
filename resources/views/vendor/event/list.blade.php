                        ...
                        <div class="col-md-12 col-xs-12">
                            ...
                            <div class="section row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <label class="">About patient</label>
                                    <label for="" class="field">
                ...
                <div class="modal-body">
                    ...
                    <form id="create_event_frm"  action="{{route('event')}}"  method="post" enctype="multipart/form-data"  >
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-xs-12">
                                <div class="form-group">
                                    <input type="text" name="event_title" id="event_title" required=""  class="form-control" placeholder="Doctors">
                        ...
                        <div class="section row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <textarea class="form-control" id="event_description" name="event_description" placeholder="About patient" ></textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <form id="edit_event_frm" action=""  method="post" enctype="multipart/form-data"  >
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-xs-12">
                                <div class="form-group">
                                    <label class="">Doctors</label>
                                    <input type="text" name="event_title" id="edit_event_title" required=""  class="form-control" placeholder="Doctors">
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="">About patient</label>
                                    <textarea class="form-control" id="edit_event_description" name="event_description" placeholder="About patient" ></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="section" style="margin-top: 10px">
        ...
        function get_data(){
            ...
            $.get(event_url, function (r) {
                ...
                $.each(ad, function(i,item){
                    ...
                    html += '<td class="text-left">'+ad[i].event_description+'</td>';
